    ...
    <div class="w3-col w3-container" style="width:70%" align="left">
        <div class="w3-padding" style="margin-left: 40px"><h4 style="font-family:Times"><i><b>Welcome Mr.wordSmith</b></i></h4></div>
            ...
            <table cellspacing="2" cellpadding="1">
                <tr>
                    <td style="font-size: small">First Name: <input type="hidden" name="firstname" id="firstname" value=""/></td>
                </tr>
                <tr>
                    <td style="font-size: small">Last Name: <input type="hidden" name="lastname" id="lastname" value=""/></td>
                </tr>
                <tr>
                    <td style="font-size: small" >Date Of Birth: <input type="hidden" name="dob" id="dob" value=""/></td>
                </tr>
                <tr>
                    <td style="font-size: small">Email:<input type="hidden" name="email" id="email" value=""/></td>
                </tr>
                <tr>
                    <td style="font-size: small" >Phone:<input type="hidden" name="phone" id="phone" value=""/></td>
                </tr>
                <tr>
                    <td style="font-size: small">Address:<input type="hidden" name="address" id="address" value=""/></td>
                </tr>
            </table>
            </form>
            </div>
            ...
            <div class="w3-col w3-container" style="width:70%">
                <form class="w3-container" style="font-size: small"><br>
                    ...
                    <p>
                        ...
                        <input class="w3-input" type="text"></p>
                    <p>
                        <button class="w3-btn w3-black">Save</button></p>
                </form>
            </div>
        </div>
        ...
        <div id="My important date" class="w3-container name" style="display:none">
            <div class="w3-col w3-container" style="width:70%">
                <form class="w3-container">
                    ...
                    <p style="font-size: small"> We will remember the important date for you! Leave your event details to receive an email reminder 10 days prior to your event.</p><br>
                    <br>
                    <table cellspacing="10" cellpadding="5" style="font-size: small">

                        <th>Date</th><th>Event</th>
                        <tr>
                            <td style="font-size: small" width="25%"><input type="hidden" name="e1date" id="e1date" value=""/></td>
                            <td style="font-size: small" width="40"><input type="hidden" name= id="e1event" value=""/></td>
                            <td><input class="w3-button"width="10%"value="REMOVE"></td>
                        </tr>
                        <tr>
                            <td style="font-size: small" width="30%"><input type="hidden" name="e2date" id="e2date" value=""/></td>
                            <td style="font-size: small"width="40%"><input type="hidden" name= id="e2event" value=""/></td>
                            <td><input class="w3-button"width="10%"value="REMOVE"></td>
                        </tr>
                        <tr>
                            <td style="font-size: small" width="30%"><input type="hidden" name="e3date" id="e3date" value=""/></td>
                            <td style="font-size: small"width="40%"><input type="hidden" name= id="e3event" value="e3event"/></td>
                            <td><input class="w3-button"width="10%" value="REMOVE"></td>
                        </tr>
                        <tr>
                            <td style="font-size: small" width="30%"><input type="hidden" name="e4date" id="e4date" value=""/></td>
                            <td style="font-size: small"width="40%"><input type="hidden" name= id="e4event" value=""/></td>
                            <td><input class="w3-button" width="10%"value="REMOVE"></td>
                        </tr>
                        <tr>
                            <td style="font-size: small"width="30%"><input type="hidden" name="e5date" id="e5date" value=""/></td>
                            <td style="font-size: small"width="40%"><input type="hidden" name= id="e5event" value=""/></td>
        ...
        <div id="My order" class="w3-container name" style="display:none">
            ...
            <div class="w3-col w3-container" style="width:70%"><div class="w3-padding" style="margin-left: 40px"></div>
                <form class="w3-container">
                    <br>
                    <h5 style="text-align:left"><b>My Order</b></h5>
                    <p style="font-size: small" > View your order history here</p><br><br>
                    <i><b><p style="font-size: small;font-family:Times"> * Any issues with a order please contact order for Mr.WordSmith.com with your order</p></b></i>

                    <table cellspacing="10" cellpadding="5" style="font-size: small">

                        <th>Summary</th><th>Order number</th><th>Order Placed</th><th>Total</th>
                        <tr>
                            <td style="font-size: small" width="30%"><input type="hidden" name="o1summary" id="o1summary" value=""/></td>
                            <td style="font-size: small" width="30%"><input type="hidden" name="o1number"id="o1number" value=""/></td>
                            <td style="font-size: small" width="30%"><input type="hidden" name="o1time" id="o1time" value=""/></td>
                            <td style="font-size: small" width="35%"><input type="hidden" name="o1total"id="o1total" value=""/></td>
                        </tr>
                        <tr>
                            <td style="font-size: small" width="30%"><input type="hidden" name="o2summary" id="o2summary" value=""/></td>
                            <td style="font-size: small" width="30%"><input type="hidden" name="o2number"id="o2number" value=""/></td>
                            <td style="font-size: small" width="30%"><input type="hidden" name="o2time" id="o2time" value=""/></td>
                            <td style="font-size: small" width="35%"><input type="hidden" name="o2total"id="o2total" value=""/></td>
                        </tr>
                        <tr>
                            <td style="font-size: small" width="30%"><input type="hidden" name="o3summary" id="o3summary" value=""/></td>
                            <td style="font-size: small" width="30%"><input type="hidden" name="o3number"id="o3number" value=""/></td>
                            <td style="font-size: small" width="30%"><input type="hidden" name="o3time" id="o3time" value=""/></td>
                            <td style="font-size: small" width="35%"><input type="hidden" name="o3total"id="o3total" value=""/></td>
                        </tr>
                        <tr>
                            <td style="font-size: small" width="30%"><input type="hidden" name="o4summary" id="o4summary" value=""/></td>
                            <td style="font-size: small" width="30%"><input type="hidden" name="o4number"id="o4number" value=""/></td>
                            <td style="font-size: small" width="30%"><input type="hidden" name="o4time" id="o4time" value=""/></td>
                            <td style="font-size: small" width="35%"><input type="hidden" name="o4total"id="o4total" value=""/></td>
                        </tr>
                        <tr>
                            <td style="font-size: small" width="30%"><input type="hidden" name="o5summary" id="o5summary" value=""/></td>
                            <td style="font-size: small" width="30%"><input type="hidden" name="o5number"id="o5number" value=""/></td>
                            <td style="font-size: small" width="30%"><input type="hidden" name="o5time" id="o5time" value=""/></td>
                            <td style="font-size: small" width="35%"><input type="hidden" name="o5total"id="o5total" value=""/></td>
                        </tr>
                    </table>
                </form>
            </div>
