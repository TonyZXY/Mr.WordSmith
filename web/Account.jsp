...
<div class="content">
    ...
    <div class="w3-row">
        <div class=" w3-col w3-bar-block w3-white " style="width:25%">
            ...
            <div class="w3-panel w3-border-bottom w3-border-light-grey"
            ...
            <button class="w3-bar-item w3-button tablink w3-center" onclick="openFile(event, 'My order')">My Order
            </button>
            <button class="w3-bar-item w3-button tablink w3-center" onclick="openFile(event, 'My important date')">
                Important
                Dates
            </button>
            <button class="w3-bar-item w3-button tablink w3-center" onclick="openFile(event, 'Change Password')">Change
                Password
            </button>
        </div>
        ...
        <div class="w3-col w3-container" style="width:70%" align="left">
            ...
            <div style="margin-left: 40px">
                <table cellspacing="2" cellpadding="1">
                    <tr>
                        <td style="font-size: small">First Name: <%=user.getFirstName()%><input type="hidden"name="firstname" id="firstname" value=""/>
                        </td>
                    </tr>
                    <tr>
                        <td style="font-size: small">Last Name: <%=user.getLastName()%><input type="hidden" name="lastname" id="lastname" value=""/>
                        </td>
                    </tr>
                    <tr>
                ...
                <div class="w3-col w3-container" style="width:70%">
                    <form class="w3-container" style="font-size: small" action="UpdateAccountDetails" method="post"><br>
                        ...
                        <p>
                            ...
                            <input class="w3-input" placeholder="DD-MM" type="date" name="DoB"></p>
                        <p>
                            <label>Phone</label>
                            <input class="w3-input" type="number" name="PN"></p>
                        <p>
                            <label>Address</label>
                ...
                <div class="w3-col w3-container" style="width:70%">
                    ...
                    <form action="AddNewEvent" method="post">
                        <p style="font-size: small">
                            <label>Date</label>
                            <input class="w3-input" name="time" type="date" placeholder="DD-MM"></p>
                        <p style="font-size: small">
                            <label>Event</label>
            ...
            <div id="My order" class="w3-container name" style="display:none">
                ...
                <div class="w3-col w3-container" style="width:70%">
                    ...
                    <form class="w3-container">
                        ...
                        <i><b><p style="font-size: small;font-family:Times"> * Any issues with a order please contact
                            order
