...
<header class="w3-display-container w3-content w3-wide" style="max-width:1600px;min-width:500px">
    <center><img class="w3-image" src="images/Ad 3.jpg" alt="Hamburger Catering" width="1000" height="800"></center>
</header>
<br><br><br>
...
<div class="w3-container w3-content w3-center w3-padding-64" style="max-width:800px" id="band">
    <h2 class="w3-wide">BRANDING</h2><br>
    <p class="w3-justify">Your branding is the difference between success and failure
        Your branding is just as important as your product (if not more so)!
        In an increasingly saturated marketplace,
        it is more important than ever to have a unique and engaging presence.
        Strategic design and branding can help
        cut through the clutter and showcase your product in the best possible light.</p>
    <br>
    <h2 class="w3-wide">GRAPHIC DESIGN</h2>
    <p class="w3-justify">Not just a skill but an art form.

        This is how you visually communicate with your audience, your brand cannot function without excellent graphic
        design!
        We meticulously navigate every stage of the creative process to ensure we produce premium quality outputs that
        pinpoint the
        very essence of your brand.
        It's an exciting process, just ask us!</p>
</div>
